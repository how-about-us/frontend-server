  ...
  return (
    <div className="pointer-events-none absolute bottom-6 left-1/2 z-[17] -translate-x-1/2">
      <button
        type="button"
        onClick={onPress}
        className="pointer-events-auto inline-flex cursor-pointer items-center gap-1 rounded-full border-3 border-brand-red bg-white px-3 py-2 text-xs font-semibold text-dark-gray shadow-md transition hover:bg-gray-50"
      >
        <RefreshCw
