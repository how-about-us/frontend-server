...
export const LANDING_HERO_SCREENSHOT: LandingScreenshotSpec = {
  src: `${landingAssetDir}/hero-app.png`,
...
export const LANDING_FEATURE_SCREENSHOTS = {
  chat: {
    src: `${landingAssetDir}/feature-chat.png`,
    alt: "우때 실시간 채팅 — 장소 공유와 AI 추천",
    width: 960,
    height: 600,
  },
  map: {
    src: `${landingAssetDir}/feature-map.png`,
    alt: "우때 지도 — 장소 탐색과 북마크",
    width: 960,
    height: 600,
  },
  plan: {
    src: `${landingAssetDir}/feature-plan.png`,
    alt: "우때 일정 — 날짜별 여행 계획과 이동 경로",
    width: 960,
    height: 600,
  },
  ai: {
    src: `${landingAssetDir}/feature-ai.png`,
